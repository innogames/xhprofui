 ...
 */
class Version20140704154715 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE profiling_data (id INT NOT NULL, parent_id INT DEFAULT NULL, profiling_id INT NOT NULL, method VARCHAR(255) NOT NULL, lft INT NOT NULL, lvl INT NOT NULL, rgt INT NOT NULL, root INT DEFAULT NULL, PRIMARY KEY(id))");
